...
export async function POST(req: Request) {
  try {
    ...
    console.error("PATTERN_SEQUENCE FINISH ERROR:", error);
    return NextResponse.json({ error: "Could not finish Pattern Sequence." }, { status: 500 });
  }
}
